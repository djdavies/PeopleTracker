...
class GoogleResultsMichaelJuckesCardiffUniversity extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $resultJson = Storage::get('michael_juckes_cardiff_university.json');
        ...
        Storage::delete('michael_juckes_cardiff_university.json');
    }
}
