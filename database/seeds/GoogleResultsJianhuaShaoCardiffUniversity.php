...
class GoogleResultsJianhuaShaoCardiffUniversity extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $resultJson = Storage::get('jianhua_shao_cardiff_university.json');
        ...
        Storage::delete('jianhua_shao_cardiff_university.json');
    }
}
